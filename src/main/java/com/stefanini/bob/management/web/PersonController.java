...
public class PersonController {
    ...
    public String findPendings(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, @RequestParam(value = "workGroupId", required = false) Long workGroupId, Model uiModel) {
    ...
    private void processFindPendings(Integer page, Integer size, String sortFieldName, String sortOrder, Long workGroupId, Model uiModel) {
        ...
        if (workGroupId != null) workGroup = workGroupService.findWorkGroup(workGroupId);
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
